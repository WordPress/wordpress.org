...
#
# The support forums plugin returns early unless bbPress is loaded, so the
# environment activates bbPress alongside it.
#

set -euo pipefail

CONFIG="--config support-forums/.wp-env.test.json"
