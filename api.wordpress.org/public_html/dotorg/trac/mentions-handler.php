...
// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing -- JSON body; sanitizing would corrupt it before json_decode(). Webhook endpoint; the request is authenticated by its signature, not a nonce.
