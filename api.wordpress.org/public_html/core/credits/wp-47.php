...
class WP_47_Credits extends WP_Credits {
	...
	function external_libraries() {
		return array(
			...
			array( 'getID3()', 'https://www.getid3.org/' ),
			array( 'Horde Text Diff', 'https://pear.horde.org/' ),
			array( 'hoverIntent', 'https://github.com/briancherne/jquery-hoverIntent' ),
			...
			array( 'jQuery UI Touch Punch', 'https://touchpunch.furf.com/' ),
			array( 'json2', 'https://github.com/douglascrockford/JSON-js' ),
			array( 'Masonry', 'https://masonry.desandro.com/' ),
			...
			array( 'Requests', 'https://requests.ryanmccue.info/' ),
