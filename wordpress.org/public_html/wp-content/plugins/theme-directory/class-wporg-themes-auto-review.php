...
class Auto_Review_Controller extends WP_REST_Controller {
	...
	public function get_formatted_content( $content ) {
		...
		$disclaimer = "<p><i>The following has been generated by <a href='https://github.com/WordPress/theme-review-action'>Theme Review Action</a>, this is for informational purposes only.</i></p>";
