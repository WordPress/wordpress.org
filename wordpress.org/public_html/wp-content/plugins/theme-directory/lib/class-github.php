...
class GitHub {
	...
	public static function api( $url, $args = null, $headers = [], $method = null ) {
		...
		// This re-uses the Plugin Directory constants deliberately.
	...
	protected static function get_jwt_app_token() {
		...
		if ( ! class_exists( 'Ahc\Jwt\JWT' ) ) {
			require_once __DIR__ . '/adhocore-php-jwt/JWTException.php';
			require_once __DIR__ . '/adhocore-php-jwt/ValidatesJWT.php';
			require_once __DIR__ . '/adhocore-php-jwt/JWT.php';
		}
