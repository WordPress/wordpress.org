...
<form class="translation-event-form" action="" method="post">
	...
	<!-- wp:form-input -->
	<div class="wp-block-form-input"><label class="wp-block-form-input__label" for="event-title"><span class="wp-block-form-input__label-content"><?php esc_html_e( 'Event Title', 'wporg-translate-events-2024' ); ?></span><input class="wp-block-form-input__input" type="text" id="event-title" name="event_title" value="<?php echo esc_attr( $event->title() ); ?>" <?php echo ( $is_create_form || current_user_can( 'edit_translation_event_title', $event->id() ) ) ? '' : 'readonly'; ?> required size="42"/></label></div>
	<!-- /wp:form-input -->
...
<div class="wp-block-form-input"><label class="wp-block-form-input__label"><span class="wp-block-form-input__label-content"><?php esc_html_e( 'Event Description', 'wporg-translate-events-2024' ); ?></span><textarea class="wp-block-form-input__input" id="event-description" name="event_description" rows="4" cols="40" required <?php echo ( $is_create_form || current_user_can( 'edit_translation_event_description', $event->id() ) ) ? '' : 'readonly'; ?>><?php echo esc_html( $event->description() ); ?></textarea>
			<?php
			echo wp_kses(
