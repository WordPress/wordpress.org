...
/**
 * The date and time at which an event starts.
 */
class Event_Start_Date extends Event_Date {
	/**
	 * Prefix a formatted date with a translated "starts" phrase.
	 *
	...
	/**
	 * Generate variable text depending on when the event starts.
	 *
