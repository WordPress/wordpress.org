...
class Manager {
	...
	public static $wildcard_cron_tasks = array(
		...
		'scan_plugin'        => array( __NAMESPACE__ . '\Plugin_Updates', 'cron_trigger' ),
	...
	public function __construct() {
		...
		add_action( 'wporg_plugins_imported', array( __NAMESPACE__ . '\Plugin_Updates', 'wporg_plugins_imported' ), 10, 6 );
