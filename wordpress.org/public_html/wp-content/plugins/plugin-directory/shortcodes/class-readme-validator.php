...
class Readme_Validator {
	...
	public static function display() {
		...
		if ( ! empty( $_POST['readme_contents'] ) && is_string( $_POST['readme_contents'] ) ) {
			// phpcs:ignore WordPress.PHP.DiscouragedPHPFunctions.obfuscation_base64_decode,WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- Opaque payload; base64_decode() in strict mode is the validation.
