...
<!--				<div class="panel-header">
				...
				<div class="panel-content">
					...
					$sidebar_tabs .= '	<li class="tab-discussion" data-tab="sidebar-tab-discussion-' . $translation->row_id . '" data-row-id="' . $translation->row_id . '">Discussion&nbsp;<span class="count">(0)</span></li>';
					$sidebar_tabs .= '	<li class="tab-history" data-tab="sidebar-tab-history-' . $translation->row_id . '" data-row-id="' . $translation->row_id . '">History&nbsp;<span class="count">(0)</span></li>';
					$sidebar_tabs .= '	<li class="tab-other-locales" data-tab="sidebar-tab-other-locales-' . $translation->row_id . '" data-row-id="' . $translation->row_id . '">Other&nbsp;locales&nbsp;<span class="count">(0)</span></li>';
					$sidebar_tabs .= '</ul>';
