...
<ul class="wp-block-gallery alignwide columns-4 is-cropped gutenberg-landing--features-grid"><li class="blocks-gallery-item"><figure><img src="https://wordpress.org/gutenberg/files/2018/07/Plugin-1-1.gif" alt=""/><figcaption>' . _x( 'Accomplish more with fewer plugins.', 'Image Caption', 'gutenbergtheme' ) . '</figcaption></figure></li><li class="blocks-gallery-item"><figure><img src="https://wordpress.org/gutenberg/files/2018/07/Layout-3.gif" alt=""/><figcaption>' . _x( 'Easily create modern, multimedia-heavy layouts.', 'Image Caption', 'gutenbergtheme' ) . '</figcaption></figure></li><li class="blocks-gallery-item"><figure><img src="https://wordpress.org/gutenberg/files/2018/07/Devices-1-1.gif" alt=""/><figcaption>' . _x( 'Work across all screen sizes and devices.', 'Image Caption', 'gutenbergtheme' ) . '</figcaption></figure></li><li class="blocks-gallery-item"><figure><img src="https://wordpress.org/gutenberg/files/2018/07/Visual-1.gif" alt=""/><figcaption>' . _x( 'Trust that your editor looks like your actual website.', 'Image Caption', 'gutenbergtheme' ) . '</figcaption></figure></li></ul>
<!-- /wp:gallery -->' . "\n\n";
...
<div class="wp-block-wporg-download-button wp-block-button aligncenter"><a class="wp-block-button__link has-background has-strong-blue-background-color" href="' . "https://{$localised_domain}/plugins/gutenberg/" . '" style="background-color:rgb(0,115,170)">' . __( "Download Gutenberg Today", 'gutenbergtheme' ) . '</a></div>
