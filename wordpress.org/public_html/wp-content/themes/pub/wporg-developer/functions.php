...
function theme_scripts_styles() {
	...
	wp_enqueue_style( 'wporg-developer-style', get_stylesheet_uri(), array(), '4' );
	wp_enqueue_style( 'wp-dev-sass-compiled', get_template_directory_uri() . '/stylesheets/main.css', array( 'wporg-developer-style' ), '20220217' );
