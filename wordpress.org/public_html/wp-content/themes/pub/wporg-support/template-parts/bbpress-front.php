		...
		<div>
			...
			<div class="two-up">
				...
				<a href="https://make.wordpress.org/support/handbook/">
					...
					<p>Great for tips, tricks, and advice regarding giving the best support possible.</p>
				</a>
			</div>
		</div>
		<div>
			...
			<div class="two-up">
				<a href="<?php esc_url( __( 'https://wordpress.org/themes/', 'wporg-forums' ) ) ?>">
					<h3>Themes Forum</h3>
					<p>Head to the theme's page and find the "View support forum" link to visit the theme's individual forum.</p>
				</a>
				<a href="<?php esc_url( __( 'https://wordpress.org/plugins/', 'wporg-forums' ) ) ?>">
					<h3>Plugins Forum</h3>
					<p>Head to the plugin's page and find the "View support forum" link to visit the plugin's individual forum.</p>
				</a>
			</div>
		</div>
	</div>
