...
function wporg_support_scripts() {
	...
	wp_enqueue_style( 'forum-wp4-style', get_stylesheet_uri(), [], '20210212b' );
	...
	wp_enqueue_script( 'wporg-support-forums', get_template_directory_uri() . '/js/forums.js', array( 'jquery' ), '20210212a', true );
