...
function wporg_themes_scripts() {
	...
	wp_enqueue_style( 'wporg-themes', get_theme_file_uri( '/css/style.css' ), [ 'dashicons', 'open-sans' ], '20201118a' );
	...
	if ( ! is_singular( 'page' ) ) {
		...
		wp_enqueue_script( 'wporg-theme', get_stylesheet_directory_uri() . "/js/theme{$suffix}.js", array( 'wp-backbone' ), '20210303', true );
