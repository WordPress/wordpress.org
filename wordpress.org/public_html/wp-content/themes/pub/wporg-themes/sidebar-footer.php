<aside class="theme-widget-area" role="complementary">
	<div class="widget-wrap wrap">
		<div class="widget widget_text">
			<h3 class="widget-title"><?php esc_html_e( 'Add Your Theme', 'wporg-themes' ); ?></h3>
		...
		<div class="widget widget_text">
			<h3 class="widget-title"><?php esc_html_e( 'Create a Theme', 'wporg-themes' ); ?></h3>
			<div class="textwidget"><?php
				printf(
		...
		<div class="widget widget_text">
			<h3 class="widget-title"><?php esc_html_e( 'Stay Up-to-Date', 'wporg-themes' ); ?></h3>
			<div class="textwidget"><?php
				printf(
