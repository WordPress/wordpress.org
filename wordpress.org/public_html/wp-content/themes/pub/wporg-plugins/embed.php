		...
		<div class="wp-embed-footer">
			...
			<div class="wp-embed-meta">
				<?php if ( 'publish' === get_post_status() ) : ?>
					<a class="plugin-download button download-button button-large" href="<?php echo esc_url( Template::download_link() ); ?>"><?php esc_html_e( 'Get this plugin', 'wporg-plugins' ); ?></a>
				<?php endif; ?>
			</div>
		</div>
	</div>
