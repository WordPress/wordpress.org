		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="entry-content row">
				<section class="col-8">
					...
					<ul>
						<li><strong><?php esc_html_e( 'Simplicity', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Flexibility', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Publish with Ease', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Publishing Tools', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'User Management', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Media Management', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Full Standards Compliance', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Easy Theme System', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Extend with Plugins', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Built-in Comments', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Easy Installation and Upgrades', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Importers', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Own Your Data', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Freedom', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Community', 'wporg' ); ?></strong>
						...
						<li><strong><?php esc_html_e( 'Contribute', 'wporg' ); ?></strong>
					...
					<h3><?php esc_html_e( 'Developer Features', 'wporg' ); ?></h3>
					...
					<ul>
						<li><strong><?php esc_html_e( 'Plugin System', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php esc_html_e( 'Custom Content Types', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php esc_html_e( 'The Latest Libraries', 'wporg' ); ?></strong>
							<?php
