	...
	<main id="main" class="site-main col-12" role="main">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header class="entry-header">
				<h1 class="entry-title col-8"><?php esc_html_e( 'Features', 'wporg' ); ?></h1>
			</header><!-- .entry-header -->
			...
			<div class="entry-content row">
				<section class="col-8">
					...
					<ul>
						<li><strong><?php _ex( 'Simplicity', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Flexibility', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Publish with Ease', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Publishing Tools', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'User Management', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Media Management', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Full Standards Compliance', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Easy Theme System', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Extend with Plugins', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Built-in Comments', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Search Engine Optimized', 'Features page: Section Header', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php _ex( 'Multilingual', 'Features page: Section Header', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php _ex( 'Easy Installation and Upgrades', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Importers', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Own Your Data', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Freedom', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Community', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Contribute', 'Features page: Section Header', 'wporg' ); ?></strong>
					...
					<ul>
						<li><strong><?php _ex( 'Plugin System', 'Features page: Section Header', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php _ex( 'Theme System', 'Features page: Section Header', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php _ex( 'Application Framework', 'Features page: Section Header', 'wporg' ); ?></strong>
						...
						<li><strong><?php _ex( 'Custom Content Types', 'Features page: Section Header', 'wporg' ); ?></strong>
							<?php
						...
						<li><strong><?php _ex( 'The Latest Libraries', 'Features page: Section Header', 'wporg' ); ?></strong>
							<?php
