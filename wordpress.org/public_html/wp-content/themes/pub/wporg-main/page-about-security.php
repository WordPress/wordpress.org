				...
				<section class="col-8">
					...
					<p><?php
						printf(
							...
							esc_html__( 'WordPress is a free and open source content management system (CMS). It is the most widely-used CMS software in the world and it powers more than %1$s%% of the top 10 million websites%2$s, giving it an estimated %3$s%% market share of all sites
using a CMS.', 'wporg' ),
							WP_MARKET_SHARE,
					...
					<p><?php
						printf(
							...
							esc_html__( 'There are approximately %1$s+ plugins and %2$s+ themes listed on the WordPress.org site. These themes and plugins are submitted for inclusion and are manually reviewed by volunteers before making them available on the repository.', 'wporg'
),
