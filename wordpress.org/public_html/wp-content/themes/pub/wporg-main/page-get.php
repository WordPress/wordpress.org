...
?>
	...
	<header id="masthead" class="site-header" role="banner">
		<div class="site-branding">
			<p class="site-title"><a href="<?php echo esc_url( home_url( '/get' ) ); ?>"><?php _e( 'Get WordPress', 'wporg' ); ?></a></p>
	...
	<main id="main" class="site-main" role="main">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="entry-content">
				<section>
					<div class="container">
						<h3><?php _e( 'Requirements', 'wporg' ); ?></h3>

						<p><?php printf( __( 'You&#8217;ve got a cool new plugin and are hoping to give it some exposure. You&#8217;re in the right place. Just <a href="%s">ask us to host it for you</a>. You&#8217;ll be able to:', 'wporg' ), esc_url( home_url( 'developers/add' ) ) ); ?></p>
						<ul>
							<li><?php _e( 'Keep track of how many people have downloaded it.', 'wporg' ); ?></li>
						...
						<h3><?php _e( 'There are some restrictions', 'wporg' ); ?></h3>
						<ul>
							<li><?php printf( __( 'Your plugin must be compatible with the <a href="%s">GNU General Public License v2</a>, or any later version. We strongly recommend using the same license as WordPress — &#8220;GPLv2 or later.&#8221;', 'wporg' ), esc_url( 'http://www.gnu.org/licenses/license-list.html#GPLCompatibleLicenses' ) ); ?></li>
						...
						<h3><?php _e( 'Submission is Simple', 'wporg' ); ?></h3>
						<ol>
							<li><?php printf( __( '<a href="%s">Sign up</a> for an account on WordPress.org.', 'wporg' ), esc_url( 'https://wordpress.org/support/register.php' ) ); ?></li>
							...
							<li>
								...
								printf( __( 'Shortly after you upload your plugin (and a <a href="%1$s">readme file</a>!) to that repository, it will be automatically displayed in the <a href="%2$s">plugins browser</a>.', 'wporg' ), '#readme', esc_url( home_url( '/' ) ) );
								?>
							</li>
							<li><?php printf( __( 'Check out the <strong><a href="%s">FAQ</a> </strong>for more information.', 'wporg' ), esc_url( 'https://developer.wordpress.org/plugins/wordpress-org/plugin-developer-faq/' ) ); ?></li>
						</ol>

						<h3 id="readme"><?php _e( 'Readme files', 'wporg' ); ?></h3>
						<p>
							<?php
				...
				<section>
					<div class="container">
						<h3><?php _e( 'Beta Releases', 'wporg' ); ?></h3>
