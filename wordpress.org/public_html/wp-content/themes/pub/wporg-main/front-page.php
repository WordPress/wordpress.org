...
?>
	...
	<main id="main" class="site-main " role="main">
		<div class="home-welcome">
			...
			<section class="features">
				...
				<p><?php
					...
					printf( __( 'Extend WordPress with over 45,000 plugins to help your website meet your needs. Add an online store, galleries, mailing lists, forums, analytics, and <a href="%s">much more</a>.', 'wporg' ), esc_url( 'https://wordpress.org/plugins/' ) ); ?></p>
			</section>
		...
		<div id="home-below" class="home-below row gutters">
			<div class="col-4">
				<h4><a href="https://wordpress.org/news/"><?php _e( 'News From Our Blog', 'wporg' ); ?></a></h4>
			...
			<div class="col-4">
				...
				<ol class="steps">
					...
					<li class="two"><span></span><?php printf( __( '<a href="%s">Download &amp; Install WordPress</a> with our famous 5-minute&nbsp;installation. Feel like a rock star.', 'wporg' ), esc_url( 'https://wordpress.org/download/' ) ); ?></li>
