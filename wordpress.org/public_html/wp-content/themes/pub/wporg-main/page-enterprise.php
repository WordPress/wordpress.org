		...
		<article id="post-1">
			<header class="entry-header">
				<hgroup class="header-group">
					<img width="300" src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/hero.png' ) ); ?>">
			...
			<div class="entry-content row enterprise-logos">
				...
				<section class="col-2">
					<img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/spotifylogo.png' ) ); ?>">
				</section>
				<section class="col-2">
					<img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/tedlogo.png' ) ); ?>">
				</section>
				<section class="col-2">
					<img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/facebooklogo.png' ) ); ?>">
				</section>
				<section class="col-2">
					<img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/jetlogo.png' ) ); ?>">
				</section>
				<section class="col-2">
					<img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/microsoftlogo.png' ) ); ?>">
				</section>
				<section class="col-2">
					<img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/cnnlogo.png' ) ); ?>">
				</section>
			</div>
			</div>
			...
			<div class="entry-content row applications">
				...
				<div class="entry-content row applications-list">
					<section class="col-3">
						...
						<div class="box mediapublishing"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/mediapublishing.png' ) ); ?>"></div>
						<p>WordPress powers the sites people visit multiple times every day for news, information and entertainment.</p>
					</section>
					<section class="col-3">
						<h4>eCommerce</h4>
						<div class="box ecommerce"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/ecommerce.png' ) ); ?>"></div>
						<p>Organizations around the world choose WordPress as the ecommerce solution of choice for their needs.</p>
					</section>
					<section class="col-3">
						<h4>Content Marketing</h4>
						<div class="box contentmarketing"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/contentmarketing.png' ) ); ?>"></div>
						<p>WordPress will help you get your brand&apos;s story in front of your potential customers quickly and easily.</p>
					</section>
					<section class="col-3">
						<h4>Higher education</h4>
						<div class="box education"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/education.png' ) ); ?>"></div>
			...
			<div class="entry-content row features">
				...
				<div class="entry-content row features-list">
					<section class="col-4">
						<div class="box"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/extensibility.png' ) ); ?>"></div>
						<h4>Extensibility</h4>
					...
					<section class="col-4">
						<div class="box"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/security.png' ) ); ?>"></div>
						<h4>Security</h4>
					...
					<section class="col-4">
						<div class="box"><img src="<?php echo esc_url( get_theme_file_uri( 'images/enterprise/opensource.png' ) ); ?>"></div>
						<h4>Open Source</h4>
