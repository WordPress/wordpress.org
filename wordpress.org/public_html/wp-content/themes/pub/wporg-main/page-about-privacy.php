	...
	<main id="main" class="site-main col-12" role="main">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="entry-content row">
				<section class="col-8">
					<p><?php esc_html_e( 'WordPress.org websites (collectively &ldquo;WordPress.org&rdquo; in this document) refer to sites hosted on the WordPress.org, WordPress.net, WordCamp.org, BuddyPress.org, bbPress.org, and other related domains and subdomains thereof. This privacy policy describes how WordPress.org uses and protects any information that you give us. We are committed to ensuring that your privacy is protected. If you provide us with personal information through WordPress.org, you can be assured that it will only be used in accordance with this privacy statement.', 'wporg' ); ?></p>
					...
					<h3><?php esc_html_e( 'Protection of Certain Personally-Identifying Information', 'wporg' ); ?></h3>
					<p><?php echo esc_html_e( 'WordPress.org discloses potentially personally-identifying and personally-identifying information only to those of project administrators, employees, contractors, and affiliated organizations that (i) need to know that information in order to process it on WordPress.org&#8217;s behalf or to provide services available through WordPress.org, and (ii) that have agreed not to disclose it to others. Some of those employees, contractors and affiliated organizations may be located outside of your home country; by using WordPress.org, you consent to the transfer of such information to them.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'WordPress.org will not rent or sell potentially personally-identifying and personally-identifying information to anyone. Other than to project administrators, employees, contractors, and affiliated organizations, as described above, WordPress.org discloses potentially personally-identifying and personally-identifying information only when required to do so by law, if you give permission to have your information shared, or when WordPress.org believes in good faith that disclosure is reasonably necessary to protect the property or rights of WordPress.org, third parties, or the public at large.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'If you are a registered user of a WordPress.org website and have supplied your email address, WordPress.org may occasionally send you an email to tell you about new features, solicit your feedback, or just keep you up to date with what&#8217;s going on with WordPress.org and our products. We primarily use our blog to communicate this type of information, so we expect to keep this type of email to a minimum.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'If you send us a request (for example via a support email or via one of our feedback mechanisms), we reserve the right to publish it in order to help us clarify or respond to your request or to help us support other users. WordPress.org takes all measures reasonably necessary to protect against the unauthorized access, use, alteration, or destruction of potentially personally-identifying and personally-identifying information.', 'wporg' ); ?></p>

					<h3><?php esc_html_e( 'Use of personal information', 'wporg' ); ?></h3>
					<p><?php echo esc_html_e( 'We use the information you provide to register for an account, attend our events, receive newsletters, use certain other services, or participate in the WordPress open source project in any other way.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'We will not sell or lease your personal information to third parties unless we have your permission or are required by law to do so.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'We would like to send you email marketing communication which may be of interest to you from time to time. If you have consented to marketing, you may opt out later.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'You have a right at any time to stop us from contacting you for marketing purposes.  If you no longer wish to be contacted for marketing purposes, please click on the unsubscribe link at the bottom of the email.', 'wporg' ); ?></p>

					<h3><?php esc_html_e( 'Legal grounds for processing personal information', 'wporg' ); ?></h3>
					<p><?php echo esc_html_e( 'We rely on one or more of the following processing conditions:', 'wporg' ); ?></p>
					<ul>
						<li><?php echo esc_html_e( 'our legitimate interests in the effective delivery of information and services to you;', 'wporg' ); ?></li>
						<li><?php echo esc_html_e( 'rely on explicit consent', 'wporg' ); ?></li>
						<li><?php echo esc_html_e( 'to perform our obligations under the terms and conditions.', 'wporg' ); ?></li>
					</ul>

					<h3><?php esc_html_e( 'Access to data', 'wporg' ); ?></h3>
					<p><?php echo esc_html_e( 'You have the right to request a copy of the information we hold about you. If you would like a copy of some or all your personal information, please follow the instructions at the end of this policy.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'All WordCamp attendee-provided data can be viewed and changed by the attendee via the Access Token URL that is emailed to confirm a successful ticket purchase.', 'wporg' ); ?></p>
					...
					<p><?php echo esc_html_e( 'We will retain your personal information on our systems only for as long as we need to, for the success of the WordPress open source project and the programs that support WordPress.org. We keep contact information (such as mailing list information) until a user unsubscribes or requests that we delete that information from our live systems. If you choose to unsubscribe from a mailing list, we may keep certain limited information about you so that we may honor your request.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'WordPress.org will not delete personal data from logs or records necessary to the operation, development, or archival records of the WordPress open source project.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'WordPress.org shall maintain WordCamp attendee data for 3 years to better track and foster community growth and to preserve our ability to respond to code of conduct complaints.', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'On WordCamp.org sites, banking/financial data collected as part of a reimbursement request is deleted from WordCamp.org 7 days after the request is marked paid. The reason for the 7-day retention period is to prevent organizers having to re-enter their banking details if a wire fails or if a payment was marked “Paid” in error. Invoices and receipts related to WordCamp expenses are retained for 7 years after the close of the calendar year’s audit, by instruction of our financial consultants (auditors & bookkeepers).', 'wporg' ); ?></p>
					<p><?php echo esc_html_e( 'We will anonymise the data of data subjects and/or remove their information from publicly accessible sites if the deletion of data would break essential systems or damage the logs or records necessary to the operation, development, or archival records of the WordPress open source project.', 'wporg' ); ?></p>

					<h3><?php esc_html_e( 'Rights in relation to your information', 'wporg' ); ?></h3>
					<p><?php echo esc_html_e( 'You may have certain rights under data protection law in relation to the personal information we hold about you. In particular, you may have a right to:', 'wporg' ); ?></p>
					<ul>
						<li><?php echo esc_html_e( 'request a copy of personal information we hold about you;', 'wporg' ); ?></li>
						<li><?php echo esc_html_e( 'ask that we update the personal information we hold about you, or independently correct such personal information that you think is incorrect or incomplete;', 'wporg' ); ?></li>
						<li><?php echo esc_html_e( 'ask that we delete personal information that we hold about you from live systems and not archives, or restrict the way in which we use such personal information;', 'wporg' ); ?></li>
						<li><?php echo esc_html_e( 'object to our processing of your personal information; and/or', 'wporg' ); ?></li>
						<li><?php echo esc_html_e( 'withdraw your consent to our processing of your personal information (to the extent such processing is based on consent and consent is the only permissible basis for processing).', 'wporg' ); ?></li>
					</ul>
					<p><?php echo esc_html_e( 'If you would like to exercise these rights or understand if these rights apply to you, please follow the instructions at the end of this Privacy statement.', 'wporg' ); ?></p>

					<h3><?php esc_html_e( 'Third Party Links', 'wporg' ); ?></h3>
					<p><?php echo esc_html_e( 'Our website may contain links to other websites provided by third parties not under our control.  When following a link and providing information on that link please be aware that we are not responsible for the data provided to that third party.  This privacy policy only applies to this website, so when you visit other websites, even when you click on a link posted on WordPress.org, you should read their own privacy policies.', 'wporg' ); ?></p>
					...
					<p><?php echo esc_html_e( 'Please contact us if you have any questions about our privacy policy or information we hold about you by emailing dpo@wordpress.org', 'wporg' ); ?></p>
