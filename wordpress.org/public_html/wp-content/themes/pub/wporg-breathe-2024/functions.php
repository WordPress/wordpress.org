...
function welcome_box() {
	...
	<div class="make-welcome">
		...
		<div class="entry-content clear" id="make-welcome-content" data-cookie="<?php echo $cookie; ?>" data-hash="<?php echo $content_hash; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Topic list markup assembled by the theme helpers from escaped parts. ?>">
			<script type="text/javascript">
...
function breathe_content_nav( $nav_id ) {
	...
	?>
	<nav role="navigation" id="<?php echo esc_attr( $nav_id ); ?>" class="<?php echo $nav_class; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Topic list markup assembled by the theme helpers from escaped parts. ?>">
