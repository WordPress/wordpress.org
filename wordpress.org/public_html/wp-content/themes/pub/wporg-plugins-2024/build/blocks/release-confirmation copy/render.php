...
use function WordPressdotorg\Plugin_Directory\Theme\{get_previous_version};
...
?>
<form 
	data-wp-on--submit="actions.handlePreSubmit" 
	data-wp-interactive="async-action-block" <?php echo wp_kses_data( get_block_wrapper_attributes() ); ?>
>
	...
	<div class="wp-block-group has-blueberry-4-background-color has-background" style="border-radius:2px;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)"><!-- wp:heading {"level":4,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
		...
		<p  class="has-small-font-size"><?php echo wp_kses_post( __( 'Would you like to release these changes?', 'wporg-plugins' ) ); ?></p>
		<!-- /wp:paragraph -->
